...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'league_match', 'season',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='matches', to=orm['league.Season']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.season'
        db.delete_column(u'league_match', 'season_id')
