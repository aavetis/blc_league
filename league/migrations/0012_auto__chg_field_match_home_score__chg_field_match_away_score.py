...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'league_match', 'home_score', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

        # Changing field 'Match.away_score'
        db.alter_column(u'league_match', 'away_score', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
    ...
    models = {
        ...
        u'league.match': {
            ...
            'away_score': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'home': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'home_team'", 'to': u"orm['league.Team']"}),
            'home_score': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
