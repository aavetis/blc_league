...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'league_match', (
            ...
            ('home', self.gf('django.db.models.fields.related.ForeignKey')(related_name='home_team', to=orm['league.Team'])),
            ('home_score', self.gf('django.db.models.fields.PositiveSmallIntegerField')(blank=True)),
            ('away', self.gf('django.db.models.fields.related.ForeignKey')(related_name='away_team', to=orm['league.Team'])),
            ('away_score', self.gf('django.db.models.fields.PositiveSmallIntegerField')(blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='1', max_length=1)),
        ))
        db.send_create_signal(u'league', ['Match'])

        # Adding M2M table for field messages on 'Match'
        m2m_table_name = db.shorten_name(u'league_match_messages')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('match', models.ForeignKey(orm[u'league.match'], null=False)),
            ('matchmessage', models.ForeignKey(orm[u'league.matchmessage'], null=False))
        ))
        db.create_unique(m2m_table_name, ['match_id', 'matchmessage_id'])

        # Adding model 'MatchMessage'
        db.create_table(u'league_matchmessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sent_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'league', ['MatchMessage'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field messages on 'Match'
        db.delete_table(db.shorten_name(u'league_match_messages'))

        # Deleting model 'MatchMessage'
        db.delete_table(u'league_matchmessage')
    ...
    models = {
        ...
        u'league.match': {
            ...
            'away_score': ('django.db.models.fields.PositiveSmallIntegerField', [], {'blank': 'True'}),
            'home': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'home_team'", 'to': u"orm['league.Team']"}),
            'home_score': ('django.db.models.fields.PositiveSmallIntegerField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
