...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Season.info'
        db.add_column(u'league_season', 'info',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=2000, blank=True),
                      keep_default=False)

        # Deleting field 'Squad.info'
        db.delete_column(u'league_squad', 'info')


    def backwards(self, orm):
        # Deleting field 'Season.info'
        db.delete_column(u'league_season', 'info')

        # Adding field 'Squad.info'
        db.add_column(u'league_squad', 'info',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=2000, blank=True),
                      keep_default=False)
