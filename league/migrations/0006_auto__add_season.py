...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Season'
        db.create_table(u'league_season', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='P', max_length=1)),
        ))
        db.send_create_signal(u'league', ['Season'])

        # Adding M2M table for field teams on 'Season'
        m2m_table_name = db.shorten_name(u'league_season_teams')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('season', models.ForeignKey(orm[u'league.season'], null=False)),
            ('team', models.ForeignKey(orm[u'league.team'], null=False))
        ))
        db.create_unique(m2m_table_name, ['season_id', 'team_id'])


    def backwards(self, orm):
        # Deleting model 'Season'
        db.delete_table(u'league_season')

        # Removing M2M table for field teams on 'Season'
        db.delete_table(db.shorten_name(u'league_season_teams'))
    ...
    models = {
        ...
        u'league.season': {
            ...
            'teams': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'teams'", 'symmetrical': 'False', 'to': u"orm['league.Team']"})
        },
        u'league.squad': {
