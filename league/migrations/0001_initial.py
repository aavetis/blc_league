...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'league_player', (
            ...
            ('blc_name', self.gf('django.db.models.fields.TextField')()),
        ))
        ...
        db.create_table(u'league_team', (
            ...
            ('bio', self.gf('django.db.models.fields.TextField')(max_length=600)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'league', ['Team'])

        # Adding model 'Squad'
        db.create_table(u'league_squad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'league', ['Squad'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'league_squad')
    ...
    models = {
        ...
        u'league.player': {
            ...
            'blc_name': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
