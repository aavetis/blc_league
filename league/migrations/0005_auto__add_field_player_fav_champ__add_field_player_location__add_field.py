...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.fav_champ'
        db.add_column(u'league_player', 'fav_champ',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)

        # Adding field 'Player.location'
        db.add_column(u'league_player', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True),
                      keep_default=False)

        # Adding field 'Player.bio'
        db.add_column(u'league_player', 'bio',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=256, blank=True),
                      keep_default=False)


        # Changing field 'Player.blc_name'
        db.alter_column(u'league_player', 'blc_name', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):
        # Deleting field 'Player.fav_champ'
        db.delete_column(u'league_player', 'fav_champ')

        # Deleting field 'Player.location'
        db.delete_column(u'league_player', 'location')

        # Deleting field 'Player.bio'
        db.delete_column(u'league_player', 'bio')


        # Changing field 'Player.blc_name'
        db.alter_column(u'league_player', 'blc_name', self.gf('django.db.models.fields.TextField')())
